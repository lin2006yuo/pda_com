                        ...
                        <table class="table" width="100%">
                            ...
                            <virtual-list  :start="start" :size="36" :remain="virtualRemain">
                                ...
                                >
                                    ...
                                    <td width="8%"><i class="mintui mintui-back back"></i></td>
                                </tr>
                            </virtual-list>
                            </tbody>
                        </table>
            ...
            line_off(item,num){
                ...
                this.putawayOrderData.forEach((row,index)=>{
                    if(row.id===item.id){
                        ...
                        this.listData.sku_id = row.sku_id;
                    ...
                    if(!find){
                        ...
                        for(let i = this.line_now; i < this.putawayOrderData.length; i++){
                            ...
                            if(quantity === 0){
                                ...
                                this.listData = {
                                    ...
                                    sku_id:this.putawayOrderData[i].sku_id
                                };
                        ...
                        if(this.line_now===this.putawayOrderData.length){
                            ...
                            this.listData = {
                                ...
                                sku_id:this.putawayOrderData[index].sku_id,
                            };
